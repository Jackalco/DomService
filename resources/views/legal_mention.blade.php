...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Page mentions légales de DOM Services">
        <link rel="stylesheet" type="text/css" href="{{ asset('css/layouts.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ asset('css/legal_mention.css')}}">
        <script src="https://kit.fontawesome.com/172e84d6d0.js" crossorigin="anonymous"></script>
        <script src="{{ asset('js/navbar.js') }}"></script>

        <title>DOM Services - Mentions légales</title>
        ...
        <main>
            ...
            <section id="legalMention">
                ...
                <div class="itemLegalMention">
                    ...
                    <div class="infoLegalMention"><strong>Adresse :</strong> 257 bis Avenue de Mindin, 44250 Saint-Brevin-les-Pins</div>
                    ...
                    <div class="infoLegalMention"><strong>Email :</strong> contact.saint-brevin@domservicesfrance.fr</div>
