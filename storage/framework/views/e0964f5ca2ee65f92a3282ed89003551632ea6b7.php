<footer>
    <div id="socialMedia">
        ...
        <a id="instagram" target="_blank" href="#"><i class="fab fa-instagram-square"></i></a>
        <a id="twitter" target="_blank" href="#"><i class="fab fa-twitter-square"></i></a>
    ...
    <div id="footerAsideContainer">
        ...
        <div class="footerAside">
            <a id="legalNotice" href="<?php echo e(route('legal_notices')); ?>">Mentions légales</a>
        </div>
    </div>
